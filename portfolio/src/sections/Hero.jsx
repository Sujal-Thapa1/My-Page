...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div ref={line1Ref} className="hero-l1" style={{
        ...
        <span style={{
          ...
          color: "rgba(255,255,255,0.93)", letterSpacing: "-0.04em", lineHeight: 1.15,
          whiteSpace: "nowrap",
        }}>Sujal</span>
      </div>
      ...
      <div ref={line2Ref} className="hero-l2" style={{
        ...
        <span style={{
          ...
          fontWeight: 200, fontFamily: "'Inter','Helvetica Neue',sans-serif",
          color: "rgba(255,255,255,0.65)", letterSpacing: "-0.03em", lineHeight: 1.15,
        }}>the</span>
      </div>

      {/* LINE 3 : "Developer" — right-aligned */}
      <div ref={line3Ref} className="hero-l3" style={{
