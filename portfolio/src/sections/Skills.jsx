...
import { SiTailwindcss,SiExpress,SiMysql,SiMongodb,SiPostman } from "react-icons/si";
...
const skills = [
  ...
  { name:"Tailwind",   Icon:SiTailwindcss,color:"#38bdf8", pct:85 },
  { name:"Node.js",    Icon:FaNodeJs,     color:"#68A063", pct:70 },
  { name:"Express",    Icon:SiExpress,    color:"#555555", pct:68 },
  { name:"MySQL",      Icon:SiMysql,      color:"#4479A1", pct:72 },
  { name:"MongoDB",    Icon:SiMongodb,    color:"#47A248", pct:65 },
  { name:"GitHub",     Icon:FaGithub,     color:"#1a1a2e", pct:88 },
  { name:"Postman",    Icon:SiPostman,    color:"#FF6C37", pct:75 },
...
export default function Skills() {
  ...
  return (
    <section ref={secRef} id="skills" style={{ background:"transparent", padding:"120px 0", minHeight:"100vh" }}>
