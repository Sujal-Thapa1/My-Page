  ...
  return (
    ...
    >
      ...
      <div
        style={{
          height: 190,
          background: `linear-gradient(135deg, ${post.categoryColor}18 0%, ${post.categoryColor}38 100%)`,
          display: "flex",
          alignItems: "flex-end",
...
export default function BlogPage() {
  ...
  return (
    <div style={{ fontFamily: "'Inter','Helvetica Neue',Arial,sans-serif", background: "#F5F5F7", minHeight: "100vh" }}>
        ...
        >
          ...
          <div>
            <p style={{
              ...
              Thoughts on cloud computing, full-stack development,<br />
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 40px" }}>
          ...
          >
            ...
            <div style={{
              ...
              <button
                onClick={() => { navigate(`/blog/${featured.id}`); window.scrollTo(0, 0); }}
                style={{
      ...
      {/* ── ALL POSTS GRID ── */}
      <section id="blog-posts" style={{ background: "#F5F5F7", padding: "120px 0 140px" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 40px" }}>
          ...
          <div style={{
            display: "grid", gridTemplateColumns: "220px 1fr",
            gap: "4rem", marginBottom: 80, alignItems: "start",
          }} className="blog-header-grid">
            <span ref={gridLabelRef} style={{
              fontSize: 11, fontWeight: 500, letterSpacing: "0.14em",
            ...
            <h2 ref={gridHeadRef} style={{
              fontSize: "clamp(2.4rem, 5.5vw, 5rem)",
              fontWeight: 200, letterSpacing: "-0.04em",
              lineHeight: 1.08, color: "#1a1a2e", opacity: 0,
            }}>
              More to Read
            </h2>
          </div>
